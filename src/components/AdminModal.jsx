...
const SLOT_SEED = [
    { id: 1, time: "08:00 - 09:00", used: true, badge: "호날두", name: "호날두", course: "웹/앱", gen: 3, head: 4 },
    { id: 2, time: "09:00 - 11:00", used: true, badge: "산체스", name: "산체스", course: "클라우드", gen: 2, head: 3 },
    { id: 3, time: "11:00 - 13:00", used: true, badge: "달롯", name: "달롯", course: "보안", gen: 1, head: 2 },
    { id: 4, time: "13:00 - 14:00", used: false, badge: "미사용" },
    { id: 5, time: "14:00 - 16:00", used: false, badge: "미사용" },
    { id: 6, time: "16:00 - 18:00", used: true, badge: "브페", name: "브루노", course: "웹/앱", gen: 3, head: 4 },
    { id: 7, time: "18:00 - 20:00", used: false, badge: "미사용" },
    { id: 8, time: "20:00 - 21:00", used: true, badge: "박지성", name: "박지성", course: "웹/앱", gen: 3, head: 5 },
];
                        ...
                        {slots.map((s) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={disabled ? "admin-badge is-gray" : "admin-badge"}>
                                        {s.badge}
                                    </span>
                                </button>
                            );
